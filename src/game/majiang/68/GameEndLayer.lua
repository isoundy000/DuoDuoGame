...
function GameEndLayer:onCreate(pBuffer)   
    ...
    if pBuffer.wWinner[GameCommon:getRoleChairID()+1] == true then
        textureName = "majiang/gameend/little_account_title_win.png"   
    else
        textureName = "majiang/gameend/little_account_title_lose.png"       
    end
    local texture = cc.Director:getInstance():getTextureCache():addImage(textureName)
    ...
    uiImage_dice:setContentSize(cc.size(141.00+(line-1)*50,76.00))   
