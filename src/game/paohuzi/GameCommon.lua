...
function GameCommon:judgeGame()
    ...
    self.tableConfig.wKindID == 36 or self.tableConfig.wKindID == 37 or  CHANNEL_ID == 0 or CHANNEL_ID == 1 or CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 26 or CHANNEL_ID == 27  then
        return true
    else
        return false
    end 
