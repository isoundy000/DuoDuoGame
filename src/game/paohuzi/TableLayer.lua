...
function TableLayer:showCountDown(wChairID)
    ...
    if (CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 26 or CHANNEL_ID == 27) and (GameCommon.wKindID == 37 or GameCommon.wKindID == 34) then
...
function TableLayer:showHandCard(wChairID,effectsType,isShowEndCard)
    ...
    if isShowEndCard == true then
        ...
        if viewID == 1 and GameCommon.gameConfig.bPlayerCount == 4 and StaticData.Games[GameCommon.tableConfig.wKindID].isZuoXing4 == 0 and (CHANNEL_ID == 0 or CHANNEL_ID == 1 or CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 26 or CHANNEL_ID == 27 or GameCommon:judgeGame()) then 
            cardScale = 0.6
        end
    else
        local uiPanel_card = ccui.Helper:seekWidgetByName(self.root,"Panel_card")
...
function TableLayer:initUI()
    ...
    for i = 1, 4 do
        ...
        and GameCommon.wKindID ~= 35  and GameCommon.wKindID ~= 36  and GameCommon.wKindID ~= 37 then
            if CHANNEL_ID ~= 0 and  CHANNEL_ID ~= 1 and CHANNEL_ID ~= 10 and CHANNEL_ID ~= 11 and CHANNEL_ID ~= 26 and CHANNEL_ID ~= 27 then 
    ...
    Common:addTouchEventListener(ccui.Helper:seekWidgetByName(self.root,"Button_skin"),function() 
        ...
        elseif GameCommon:judgeGame() or  CHANNEL_ID == 0 or CHANNEL_ID == 1 or CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 26 or CHANNEL_ID == 27   then 
            UserDefault_ZiPaipaizhuo = cc.UserDefault:getInstance():getIntegerForKey(Default.UserDefault_ZiPaipaizhuo,2)
        else
    ...
    if GameCommon.tableConfig.wCurrentNumber == 0 and  GameCommon.tableConfig.nTableType > TableType_GoldRoom then
        ...
        if( CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 26 or CHANNEL_ID == 27 )and GameCommon:judgeGame()  then 
            uiPanel_playerInfoBg:setVisible(false)
        end 
    end
...
function TableLayer:showChat(pBuffer)
    ...
    elseif CHANNEL_ID == 10 or CHANNEL_ID == 11 or CHANNEL_ID == 26 or CHANNEL_ID == 27 then        
        if  wKindID == 34  then
