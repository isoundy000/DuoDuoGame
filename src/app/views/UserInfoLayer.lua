...
function UserInfoLayer:onCreate(parames)
    ...
    if UserData.User.szRealName == "" then 
        uiButton_RealName:loadTextures("user/renzheng_fs8.png","user/renzheng_fs8.png","user/renzheng_fs8.png")
    end 
...
function UserInfoLayer:updateUserInfo()
   ...
   -- uiText_name:setString(string.format("昵称:%s",UserData.User.szNickName))
    ...
    uiText_gold:setString(string.format("%s",UserData.Bag:getBagPropCount(1009)))   
    ...
    if UserData.User.szPhone == "" then
        ...
        uiButton_phone:loadTextures("user/bind.png","user/bind.png","user/bind.png")
    else
